...
trait GeneratedAlternativeFormatBlock
{
	...
	$instance->setEndKeyword($endKeyword);
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->endKeyword)
		if (!\in_array($this->endKeyword->getType(), [170, 171, 172, 173, 174, 175], true))
			throw ValidationException::invalidSyntax($this->endKeyword, [170, 171, 172, 173, 174, 175]);
		if ($this->delimiter)
