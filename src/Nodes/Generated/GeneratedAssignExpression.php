...
trait GeneratedAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 116)
			throw ValidationException::invalidSyntax($this->operator, [116]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(116, '='));
		if ($this->right)
