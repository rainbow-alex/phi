...
trait GeneratedBitwiseAndAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 129)
			throw ValidationException::invalidSyntax($this->operator, [129]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(129, '&='));
		if ($this->right)
