...
trait GeneratedBitwiseAndExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 104)
			throw ValidationException::invalidSyntax($this->operator, [104]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(104, '&'));
		if ($this->right)
