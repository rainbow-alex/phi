...
trait GeneratedBitwiseOrAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 227)
			throw ValidationException::invalidSyntax($this->operator, [227]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(227, '|='));
		if ($this->right)
