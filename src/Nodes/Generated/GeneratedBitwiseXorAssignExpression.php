...
trait GeneratedBitwiseXorAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 260)
			throw ValidationException::invalidSyntax($this->operator, [260]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(260, '^='));
		if ($this->right)
