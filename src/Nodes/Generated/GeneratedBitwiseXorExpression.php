...
trait GeneratedBitwiseXorExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 122)
			throw ValidationException::invalidSyntax($this->operator, [122]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(122, '^'));
		if ($this->right)
