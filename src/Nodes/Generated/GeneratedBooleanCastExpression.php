...
trait GeneratedBooleanCastExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 135)
			throw ValidationException::invalidSyntax($this->operator, [135]);
	...
	{
		if (!$this->operator)
			$this->setOperator(new Token(135, '(bool)'));
		if ($this->expression)
