...
trait GeneratedCoalesceAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 145)
			throw ValidationException::invalidSyntax($this->operator, [145]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(145, '??='));
		if ($this->right)
