...
trait GeneratedConcatAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 147)
			throw ValidationException::invalidSyntax($this->operator, [147]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(147, '.='));
		if ($this->right)
