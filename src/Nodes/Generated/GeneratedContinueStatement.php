...
trait GeneratedContinueStatement
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 150)
			throw ValidationException::invalidSyntax($this->keyword, [150]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(150, 'continue'));
		if ($this->levels)
