...
trait GeneratedDeclareStatement
{
	...
	protected function &getChildRef(Node $childToDetach): Node
	{
		...
		if ($this->directives === $childToDetach)
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 153)
			throw ValidationException::invalidSyntax($this->keyword, [153]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(153, 'declare'));
