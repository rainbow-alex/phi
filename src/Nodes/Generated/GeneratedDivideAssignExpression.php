...
trait GeneratedDivideAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 156)
			throw ValidationException::invalidSyntax($this->operator, [156]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(156, '/='));
		if ($this->right)
