...
trait GeneratedDoubleQuotedStringLiteral
{
    /**
     * @var \Phi\Token|null
     */
    ...
    public function _validate(int $flags): void
    {
        ...
        if ($this->leftDelimiter->getType() !== 101)
            throw ValidationException::invalidSyntax($this->leftDelimiter, [101]);
        if ($this->rightDelimiter->getType() !== 101)
            throw ValidationException::invalidSyntax($this->rightDelimiter, [101]);
