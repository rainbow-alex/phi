...
trait GeneratedForeachStatement
{
	...
	$instance->setAsKeyword($asKeyword);
	$instance->setKey($key);
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 185)
			throw ValidationException::invalidSyntax($this->keyword, [185]);
