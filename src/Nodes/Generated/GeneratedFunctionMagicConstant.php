...
trait GeneratedFunctionMagicConstant
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->token->getType() !== 187)
			throw ValidationException::invalidSyntax($this->token, [187]);
	...
	{
		if (!$this->token)
			$this->setToken(new Token(187, '__FUNCTION__'));
