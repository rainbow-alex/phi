...
trait GeneratedGreaterThanExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 117)
			throw ValidationException::invalidSyntax($this->operator, [117]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(117, '>'));
		if ($this->right)
