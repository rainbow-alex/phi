...
trait GeneratedGreaterThanOrEqualsExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 203)
			throw ValidationException::invalidSyntax($this->operator, [203]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(203, '>='));
		if ($this->right)
