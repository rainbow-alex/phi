...
trait GeneratedHeredocStringLiteral
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->leftDelimiter->getType() !== 243)
			throw ValidationException::invalidSyntax($this->leftDelimiter, [243]);
		if ($this->rightDelimiter->getType() !== 176)
			throw ValidationException::invalidSyntax($this->rightDelimiter, [176]);
