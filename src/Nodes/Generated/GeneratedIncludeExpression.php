...
trait GeneratedIncludeExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 194)
			throw ValidationException::invalidSyntax($this->keyword, [194]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(194, 'include'));
		if ($this->expression)
