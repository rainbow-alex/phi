...
trait GeneratedIncludeOnceExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 195)
			throw ValidationException::invalidSyntax($this->keyword, [195]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(195, 'include_once'));
		if ($this->expression)
