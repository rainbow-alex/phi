...
trait GeneratedIsIdenticalExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 204)
			throw ValidationException::invalidSyntax($this->operator, [204]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(204, '==='));
		if ($this->right)
