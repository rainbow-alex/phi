...
trait GeneratedIsNotIdenticalExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 206)
			throw ValidationException::invalidSyntax($this->operator, [206]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(206, '!=='));
		if ($this->right)
