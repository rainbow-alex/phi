...
trait GeneratedKeywordAndExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 211)
			throw ValidationException::invalidSyntax($this->operator, [211]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(211, 'and'));
		if ($this->right)
