...
trait GeneratedKeywordOrExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 212)
			throw ValidationException::invalidSyntax($this->operator, [212]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(212, 'or'));
		if ($this->right)
