...
trait GeneratedKeywordXorExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 213)
			throw ValidationException::invalidSyntax($this->operator, [213]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(213, 'xor'));
		if ($this->right)
