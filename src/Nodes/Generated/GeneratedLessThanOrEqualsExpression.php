...
trait GeneratedLessThanOrEqualsExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 207)
			throw ValidationException::invalidSyntax($this->operator, [207]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(207, '<='));
		if ($this->right)
