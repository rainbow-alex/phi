...
trait GeneratedLongArrayExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 130)
			throw ValidationException::invalidSyntax($this->keyword, [130]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(130, 'array'));
