...
trait GeneratedMethodMagicConstant
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->token->getType() !== 214)
			throw ValidationException::invalidSyntax($this->token, [214]);
	...
	{
		if (!$this->token)
			$this->setToken(new Token(214, '__METHOD__'));
