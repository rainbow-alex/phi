...
trait GeneratedModuloAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 216)
			throw ValidationException::invalidSyntax($this->operator, [216]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(216, '%='));
		if ($this->right)
