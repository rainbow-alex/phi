...
trait GeneratedMultiplyAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 217)
			throw ValidationException::invalidSyntax($this->operator, [217]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(217, '*='));
		if ($this->right)
