...
trait GeneratedNamespaceMagicConstant
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->token->getType() !== 220)
			throw ValidationException::invalidSyntax($this->token, [220]);
	...
	{
		if (!$this->token)
			$this->setToken(new Token(220, '__NAMESPACE__'));
