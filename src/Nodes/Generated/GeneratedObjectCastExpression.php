...
trait GeneratedObjectCastExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 223)
			throw ValidationException::invalidSyntax($this->operator, [223]);
	...
	{
		if (!$this->operator)
			$this->setOperator(new Token(223, '(object)'));
		if ($this->expression)
