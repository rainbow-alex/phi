...
trait GeneratedPostDecrementExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 152)
			throw ValidationException::invalidSyntax($this->operator, [152]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(152, '--'));
