...
trait GeneratedPowerAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 230)
			throw ValidationException::invalidSyntax($this->operator, [230]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(230, '**='));
		if ($this->right)
