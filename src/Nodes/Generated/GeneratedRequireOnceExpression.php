...
trait GeneratedRequireOnceExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 236)
			throw ValidationException::invalidSyntax($this->keyword, [236]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(236, 'require_once'));
		if ($this->expression)
