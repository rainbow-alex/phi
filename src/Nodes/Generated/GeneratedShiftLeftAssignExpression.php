...
trait GeneratedShiftLeftAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 239)
			throw ValidationException::invalidSyntax($this->operator, [239]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(239, '<<='));
		if ($this->right)
