...
trait GeneratedShiftRightAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 242)
			throw ValidationException::invalidSyntax($this->operator, [242]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(242, '>>='));
		if ($this->right)
