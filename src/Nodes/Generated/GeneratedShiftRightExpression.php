...
trait GeneratedShiftRightExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 241)
			throw ValidationException::invalidSyntax($this->operator, [241]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(241, '>>'));
		if ($this->right)
