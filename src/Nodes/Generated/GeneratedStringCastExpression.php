...
trait GeneratedStringCastExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 246)
			throw ValidationException::invalidSyntax($this->operator, [246]);
	...
	{
		if (!$this->operator)
			$this->setOperator(new Token(246, '(string)'));
		if ($this->expression)
