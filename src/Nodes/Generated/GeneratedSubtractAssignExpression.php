...
trait GeneratedSubtractAssignExpression
{
	/**
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 215)
			throw ValidationException::invalidSyntax($this->operator, [215]);
	...
	public function _autocorrect(): void
	{
		...
		if (!$this->operator)
			$this->setOperator(new Token(215, '-='));
		if ($this->right)
