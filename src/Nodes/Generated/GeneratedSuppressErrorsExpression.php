...
trait GeneratedSuppressErrorsExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 119)
			throw ValidationException::invalidSyntax($this->operator, [119]);
	...
	{
		if (!$this->operator)
			$this->setOperator(new Token(119, '@'));
		if ($this->expression)
