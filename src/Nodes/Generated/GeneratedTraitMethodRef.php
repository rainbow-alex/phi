...
trait GeneratedTraitMethodRef
{
    ...
    public static function __instantiateUnchecked($name, $doubleColon, $method)
    {
        ...
        if ($doubleColon) $doubleColon->parent = $instance;
    ...
    public function _validate(int $flags): void
    {
        ...
        if ($this->doubleColon)
        if ($this->doubleColon->getType() !== 162)
            throw ValidationException::invalidSyntax($this->doubleColon, [162]);
        if ($this->method->getType() !== 243)
            throw ValidationException::invalidSyntax($this->method, [243]);
