...
trait GeneratedUnaryMinusExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->operator->getType() !== 110)
			throw ValidationException::invalidSyntax($this->operator, [110]);
	...
	{
		if (!$this->operator)
			$this->setOperator(new Token(110, '-'));
		if ($this->expression)
