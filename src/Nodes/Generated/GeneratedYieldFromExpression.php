...
trait GeneratedYieldFromExpression
{
	/**
	 * @var \Phi\Token|null
	 */
	...
	public function _validate(int $flags): void
	{
		...
		if ($this->keyword->getType() !== 262)
			throw ValidationException::invalidSyntax($this->keyword, [262]);
	...
	{
		if (!$this->keyword)
			$this->setKeyword(new Token(262, 'yield from'));
		if ($this->expression)
